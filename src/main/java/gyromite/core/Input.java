...
import gyromite.util.AWTEventListener;
...
/**
 * The inputs manager.
 * Queue events from {@link gyromite.scene.Viewport} and send them
...
public class Input implements AWTEventListener {
    ...
    /**
     * Send events to listeners. Called by {@link gyromite.scene.Scene}.
     */
    public void process() {
